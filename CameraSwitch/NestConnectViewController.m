...
- (UIButton *)createNestConnectButton
{
    ...
    [nestConnectButton setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    [nestConnectButton setTitleColor:[UIColor blueColor] forState:UIControlStateHighlighted];
